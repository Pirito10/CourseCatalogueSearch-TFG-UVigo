...
Para o presente traballo optouse pola distancia de Levenshtein como criterio de similaridade, pola súa sinxeleza de implementación, a súa idoneidade para detectar erros tipográficos en cadeas curtas como os títulos de programas académicos, e pola dispoñibilidade dunha función nativa en PHP (\texttt{levenshtein()}) que non require dependencias externas.
...
\begin{itemize}
    ...
    \item \textbf{Apache Solr}: motor de busca de código aberto baseado en Lucene, con funcionalidades avanzadas como \textit{stemming}, análise lingüística e ponderación por relevancia. Require un servidor Solr externo.
